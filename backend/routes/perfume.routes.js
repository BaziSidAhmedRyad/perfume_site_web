...
router.post("/", authenticateToken, requireAdmin, perfumeController.createPerfume);
router.put("/:id", authenticateToken, requireAdmin, perfumeController.updatePerfume);
router.delete("/:id", authenticateToken, requireAdmin, perfumeController.deletePerfume);
